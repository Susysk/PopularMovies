...
public class APISingleton {
    ...
    public static Map<Integer,String> getFavImages() {
      return db.findall();
    }

    public static void setFavImages(Map<Integer,String> favImages) {
        APISingleton.favImages = favImages;
    }

    public static Map<Integer,String> favImages;
