...
public class MovieReviewAsyncTask extends AsyncTask<String, Void, String> {
    ...
    public static void setReviewAdapter(ReviewAdapter reviewAdapter) {
        MovieReviewAsyncTask.reviewAdapter = reviewAdapter;
    }
    ...
    public   void getTrailersDataFromJson(String moviesJsonStr){
        ...
        try {
            ...
            for (int i = 0; i < moviesArray.length(); i++) {
                ...
                review.setAuthor(newMovie.getString("author"));
                review.setId(newMovie.getString("id"));
                review.setContent(newMovie.getString("content"));
